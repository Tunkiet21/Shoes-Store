    ...
    private void loadProductDetails() {
        databaseReference.child(Constants.KEY_COLLECTION_PRODUCTS).child(productId).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(EditProductActivity.this, "Lỗi khi tải chi tiết sản phẩm: " + error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void saveProductDetails() {
        ...
        if (imageUri != null) {
            ...
            fileReference.putFile(imageUri)
                    ...
                    .addOnFailureListener(e -> Toast.makeText(EditProductActivity.this, "Lỗi tải ảnh: " + e.getMessage(), Toast.LENGTH_SHORT).show());
        } else {
            updateProductInDatabase();
        }
    }
