            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot userSnapshot : dataSnapshot.getChildren()) {
                    ...
                    if (storedPassword != null && storedPassword.equals(inputPassword)) {
                        ...
                        preferenceManager.putString(Constants.KEY_USER_ID, userSnapshot.getKey());
                        preferenceManager.putString(Constants.KEY_NAME, userSnapshot.child(Constants.KEY_NAME).getValue(String.class));
                        preferenceManager.putString(Constants.KEY_PASSWORD, storedPassword);
                        preferenceManager.putString(Constants.KEY_EMAIL, inputEmail);
